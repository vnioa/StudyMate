            ...
            <ScrollView style={styles.content}>
                <View style={styles.profileSection}>
                    {friend?.backgroundImage ? (
                        <Image
                            source={{ uri: friend.backgroundImage }}
                    ...
                    <View style={styles.statusContainer}>
                        <View style={[
                            ...
                            {
                                backgroundColor: 
                                    friend?.activityStatus === '온라인' ? theme.colors.success :
                                    friend?.activityStatus === '자리비움' ? theme.colors.warning :
                                    theme.colors.inactive
                            }
                        ]} />
                        <Text style={styles.activityStatus}>{friend?.activityStatus}</Text>
                    </View>
